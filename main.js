...
const tabsHandler = (() => {
  ...
  menuTab.addEventListener('click', () => {
    ...
    content.firstChild.replaceWith((0,_menu_js__WEBPACK_IMPORTED_MODULE_2__.default)());
  })

  const locationTab = document.querySelector('.contact');
  locationTab.addEventListener('click', () => {
    locationTab.classList.add('tab-active');
    content.firstChild.replaceWith((0,_contact_js__WEBPACK_IMPORTED_MODULE_3__.default)());
  })
})();
})();
